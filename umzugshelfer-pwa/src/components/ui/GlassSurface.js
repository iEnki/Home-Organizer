...
export const glassSurfaceClass = "glass-surface rounded-card border border-white/60 bg-white/[0.62] shadow-elevation-1 dark:border-white/[0.12] dark:bg-[#07161d]/[0.22] dark:shadow-[0_18px_60px_rgba(0,0,0,.28)]";
